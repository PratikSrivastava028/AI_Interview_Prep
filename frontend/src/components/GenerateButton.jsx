...
const GenerateButton = ({ onClick, generating, loading, hasQuestions }) => (
  <button
    ...
    className="group flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-slate-900 border border-slate-800 hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-semibold transition-all duration-300 shadow-sm hover:shadow-lg hover:shadow-slate-900/20 active:scale-[0.98]"
  >
    {generating ? (
      <>
